<header class="main-header">
 <!-- Logo -->
    <a href="{{ asset('admin/dashboard') }}" class="logo">
        ...
        <span class="logo-mini"><b>CN</b>PM</span>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <img src="https://file.tinnhac.com/resize/600x-/2019/06/30/20190630230440-2703.jpg" class="user-image" alt="User Image">
                        <span class="hidden-xs"> {{session("userAdmin")}} </span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
